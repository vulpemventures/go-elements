...
func GetAddressInfo(
	...
	p2wkh, witnessScript := getClaimScriptDetails(privateKey, liquidNetwork)

	contract, err := calculateContract(
...
func getClaimScriptDetails(
	...
	return hex.EncodeToString(p2wpkh.WitnessScript), p2wpkh.WitnessScript
}
